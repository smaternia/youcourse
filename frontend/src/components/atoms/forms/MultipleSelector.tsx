  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'border-input ring-offset-background group rounded-md border px-3 py-2 text-sm focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2',
            className
          )}
        >
        ...
        <div className="relative mt-2">
          {open && (
            <CommandList className="absolute top-0 z-10 w-full rounded-md border bg-white text-font shadow-md outline-none animate-in">
              {isLoading ? (
                <>{loadingIndicator}</>
              ) : (
                <>
